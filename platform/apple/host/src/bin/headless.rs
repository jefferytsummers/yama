...
//!
//! ```bash
//! # Analyze a video with mock backend
...
// Import inference module from the host crate
// Note: This assumes the binary is part of the yama-host-apple crate
use yama_host_apple::inference::{
    BackendType, InferenceJob, JobStatus, UploadInfo, VlmInferenceConfig,
    VlmInferenceService,
};
